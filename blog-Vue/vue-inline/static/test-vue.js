...
var childComponent = {
  ...
  props: ['myMessage'],
  template:
    '<div>{{myMessage}}A custom component! part-component! used under local scope!</div>',
};
// 创建根实例
new Vue({
  el: '#global-component',
...
var org_on = new Vue({
  ...
  data: {
    message:
      'hello Vue.jsthis.messathis.messathis.messathis.messathis.messathis.messathis.messathis.messag',
  },
  methods: {
